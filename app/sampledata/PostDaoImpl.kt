...
class PostDaoImpl(private val db: SQLiteDatabase) : PostDao {
    ...
    companion object {
        ...
        CREATE TABLE ${PostColumns.TABLE} (
            ...
            ${PostColumns.COLUMN_SHARINGS} INTEGER NOT NULL DEFAULT 0,
    ...
    object PostColumns {
        ...
        const val COLUMN_SHARINGS = "sharings"
    ...
    private fun map(cursor: Cursor): Post {
        with(cursor) {
            return Post(
                ...
                sharings = getInt(getColumnIndexOrThrow(PostColumns.COLUMN_SHARINGS)),
